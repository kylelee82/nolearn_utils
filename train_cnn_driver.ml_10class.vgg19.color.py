...
#                               "kaggle/statefarm/train/c7","kaggle/statefarm/train/c8","kaggle/statefarm/train/c9"],output_dir="./data/kaggle/statefarm/vgg_cache/")
# 2. already ran once, just load the training data
driver_cnn.load_train("./kaggle/statefarm/vgg_cache/train_data_inputs.3.cache.npy","./kaggle/statefarm/vgg_cache/train_data_targets.3.cache.npy")
###############################
...
driver_cnn.define_cnn_type1_vgg19()
# use pretrained model
# output layer is wrong, but it is OK to retrain that layer
#driver_cnn.load_model("vgg19.params")
...
driver_cnn.save_model("driver_cnn.driver_10class.224x224.vgg19.color.params")
