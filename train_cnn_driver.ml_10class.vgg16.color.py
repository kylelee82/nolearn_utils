...
driver_cnn.define_cnn_type1_driver_deep_vggnet()
# use pretrained model
# output layer is wrong, but it is OK to retrain that layer
#driver_cnn.load_model("vgg16.params")
driver_cnn.load_model("driver_cnn.driver_10class.224x224.vgg.color.params")
...
driver_cnn.save_model("driver_cnn.driver_10class.224x224.vgg.color.params")
